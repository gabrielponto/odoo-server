...
base.close()
input_name = raw_input(u'Informe o nome base. Eg: Será usado para chamar o script run e stop')
...
input_admin_password = raw_input(u'Informe a senha de administração da gerência de banco de dados do Odoo')
input_port = raw_input(u'Informe a porta em que o Odoo rodará')
input_port_s = raw_input(u'Porta Segura. Dica: Acrescente apenas 1 ao número da porta que escolheu anteriormente')
...
f = open('{}{}{}.conf'.format(base_path, 'conf/', name), 'w')
f.write(content)
f.close()